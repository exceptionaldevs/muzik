 ...
 */
public class PhoneCallEventReceiver extends BroadcastReceiver implements JXPlayer.PlayerStateListener {

    private static final String TAG = MusicCoreApplication.MUSICCORE_TAG_PREFIX + "PhoneCallEventReceiver";
    private final MusicBinder mBinder;
    private boolean mWasPlaying = false;

    public PhoneCallEventReceiver(MusicBinder binder) {
        mBinder = binder;
    }
        ...
        if (intent.getAction().equals(Intent.ACTION_HEADSET_PLUG)) {
            ...
            switch (state) {
                ...
                case 1:
                    ...
                    break;
                default:
                    Logy.d(TAG, "I have no idea what the headset state is");
            }
        }
    }
