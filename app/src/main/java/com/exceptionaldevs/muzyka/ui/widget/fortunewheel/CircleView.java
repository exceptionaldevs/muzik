...
public class CircleView extends View {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        maxCircleSize = w / 4;
        tempBitmap = Bitmap.createBitmap(w / 2, h / 2, Bitmap.Config.ARGB_8888);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        tempCanvas.drawCircle(tempBitmap.getWidth() / 2, tempBitmap.getHeight() / 2, outerCircleRadiusProgress * maxCircleSize, circlePaint);
        tempCanvas.drawCircle(tempBitmap.getWidth() / 2, tempBitmap.getHeight() / 2, innerCircleRadiusProgress * maxCircleSize, maskPaint);
        canvas.save();
        canvas.scale(2, 2);
    ...
    public void setColors(int colorA1, int colorB1) {
        startColor = colorA1;
        endColor = colorB1;
        updateCircleColor();
    }
